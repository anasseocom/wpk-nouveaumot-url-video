<a href="{{ the_permalink() }}" class="preview preview--video group block">
    {{ the_post_thumbnail('16-9_xs', array('class' => 'thumbnail')) }}
    <div class="gradient"></div>
    <div class="h-full">
        <div class="w-screen h-full"></div>
        <div class="p-4 h-full top-0 left-0">
            <div class="absolute bottom-4 right-4 w-14 sm:w-10 sm:relative sm:right-auto sm:bottom-auto sm:mt-2 sm:mb-2 group-hover:w-12 transition-all ease">
