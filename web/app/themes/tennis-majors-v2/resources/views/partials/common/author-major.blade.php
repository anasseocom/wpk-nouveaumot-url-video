...
@endphp
<a href="{{ get_author_posts_url($user_id) }}" class="user user--major mb-4 hover:shadow-lg transition-all ease">
    ...
    <div class="bg-black rounded-lg absolute w-full h-bgmajorcard bottom-0 -z-1"></div>
