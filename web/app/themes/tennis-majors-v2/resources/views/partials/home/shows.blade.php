                ...
                <a href="{{ the_permalink() }}" class="grid grid-cols-5 gap-x-8 my-12">
                    ...
                    <div class="col-span-5 mt-6 lg:mt-0 lg:col-span-2 flex items-center">
                        <div>
                            ...
                            <h3 class="mt-4 mb-3 lg:mt-8 lg:mb-6">@include('partials.single.common.time-bilingue')</h3>
        ...
        <div id="top-shows-list"  class="pl-4 sm:pl-2">
            @foreach( $shows_on_top as $show)
                ...
                <div class="mb-8">
                    ...
                    @endphp
                    <div class="top-shows-slider flex overflow-x-auto scrolling-touch snap-type-mandatory scrollbar-hidden overflow-y-hidden">
                        @posts($episodes)
