...
<div id="partners" class="py-12 px-4 md:px-10 lg:px-20 relative bg-black text-white">
    ...
    <div class="py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-20 md:gap-x-20 lg:gap-x-32 max-w-screen-xxl m-auto">
        @posts
