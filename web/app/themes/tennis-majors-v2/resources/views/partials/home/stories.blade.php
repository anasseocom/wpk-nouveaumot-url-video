...
@if( $stories_on_top )
    <div id="top-stories" class="pt-20 pb-8 pl-4 relative">
        ...
        <div class="-ml-2">
            <div id="top-stories-slider" class="flex overflow-x-auto scrolling-touch snap-type-mandatory scrollbar-hidden pt-2">
                @foreach( $stories_on_top as $post)
                    <div class="snap-align-start">
                        ...
                        @endif
                                ...
                                <div class="rounded-md overflow-hidden relative pb-12/10 mb-6 w-full shadow-sm hover:shadow-xl transform hover:-translate-y-1 transition-all duration-150 group">
