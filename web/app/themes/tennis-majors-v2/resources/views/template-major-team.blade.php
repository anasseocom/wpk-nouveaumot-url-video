...
<div id="major-page" class="pt-20 pb-8relative">
    <div class="max-w-screen-xl m-auto">
        <h2 class="text-4xl uppercase text-black text-center pb-2 mx-4">A major team</h2>
        <p class="font-bold text-center pb-8 mx-4">The best tennis writer and experts are there</p>
    </div>
    <div class="mx-4">
            ...
            @foreach( $users as $user)
                ...
                @if($user_is_major)
                    <div class="user user--major">
                        ...
                        <a href="{{ get_author_posts_url($id) }}" class="text-xs uppercase underline text-white absolute bottom-6 right-6 link--arrow link--arrow-white link--arrow-right">See content</a>
                    </div>
                @endif
            @endforeach
        </div>
                ...
                <div>
                    <div class="flex flex-row items-center my-6">
                      ...
                      <div class="ml-4">
                        ...
                        <a href="{{ get_author_posts_url($id) }}" class="text-xs uppercase underline pl-0 link--arrow link--arrow-right">Read articles</a>
                      </div>
                    </div>
                </div>
                @endif
